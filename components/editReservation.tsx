...
const EditReservation = ({reservation} : EditReservationProps) => {
    const [openTimePicker , setOpenTimePicker] = useState(false)
    const [data, setData] = useState<IReservation>(reservation);
    ...
    const handleEdit = () => {
            axios
                .put(`/api/reservations/${reservation.id}`, data)
                .then(() => {
        ...
        <div className="BOOKING_ADD">
            ...
            <div className="bg-white grid grid-cols-3 items-center p-6">
                ...
                <div className="ADD_BTN">
                    <button onClick={handleClick} className="flex items-center gap-1 text-[#ec5823] font-medium p-4 rounded-lg bg-gradient-to-b from-[#fdfdfc] to-[#f6f6f6] shadow-lg shadow-gray-300">
                        <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg"><g id=" Round / Hardware / keyboard_backspace"><path id="&#240;&#159;&#148;&#185; Icon Color" fillRule="evenodd" clipRule="evenodd" d="M29.9997 16.5H10.2447L14.5647 12.18C15.1497 11.595 15.1497 10.65 14.5647 10.065C13.9797 9.47997 13.0347 9.47997 12.4497 10.065L5.56473 16.95C4.97973 17.535 4.97973 18.48 5.56473 19.065L12.4497 25.95C13.0347 26.535 13.9797 26.535 14.5647 25.95C15.1497 25.365 15.1497 24.42 14.5647 23.835L10.2447 19.5H29.9997C30.8247 19.5 31.4997 18.825 31.4997 18C31.4997 17.175 30.8247 16.5 29.9997 16.5Z" fill="#57534E"/></g></svg>
                    </button>
                </div>
                {/*TITLE*/}
                ...
                {/*CLOSE BTN*/}
                <div onClick={handleClick} className="CLOSE_BTN">
            ...
            <div className="BOOKING_FORM bg-white flex flex-col gap-7 p-6">
                ...
                <div className="grid grid-cols-3 max-md:grid-cols-1 gap-6">
                    ...
                    {/*BUTTON TIME*/}
                    <div>
                        <button onClick={()=>setOpenTimePicker(false)} className="w-full flex items-center justify-center gap-1 p-4 rounded-lg bg-gradient-to-b from-[#fdfdfc] to-[#f6f6f6] shadow-lg shadow-gray-300">
                ...
                <div className="bg-white grid grid-cols-2 max-md:grid-cols-1 gap-6">
                    ...
                    <div className="flex items-center gap-4">
                        <span>Guest</span>
                        <button onClick={handleDecrease} className="flex items-center justify-center gap-1 p-3 rounded-lg bg-gradient-to-b from-[#fdfdfc] to-[#f6f6f6] shadow-lg shadow-gray-300">
                            <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="math-minus"><path id="math-minus_2" d="M6.66699 19.9999C6.66699 19.0794 7.41318 18.3333 8.33366 18.3333H31.667C32.5875 18.3333 33.3337 19.0794 33.3337 19.9999C33.3337 20.9204 32.5875 21.6666 31.667 21.6666H8.33366C7.41318 21.6666 6.66699 20.9204 6.66699 19.9999Z" fill="#57534E"/></g></svg>
                        </button>
                        <span className="px-3 text-2xl">{data.guests}</span>
                        <button onClick={handleIncrease} className="flex items-center justify-center gap-1 p-3 rounded-lg bg-gradient-to-b from-[#fdfdfc] to-[#f6f6f6] shadow-lg shadow-gray-300">
                            <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="math-plus"><path id="math-plus_2" d="M20.0003 6.66675C19.0799 6.66675 18.3337 7.41294 18.3337 8.33341V18.3334H8.33366C7.41318 18.3334 6.66699 19.0796 6.66699 20.0001C6.66699 20.9206 7.41318 21.6667 8.33366 21.6667H18.3337V31.6667C18.3337 32.5872 19.0799 33.3334 20.0003 33.3334C20.9208 33.3334 21.667 32.5872 21.667 31.6667V21.6667H31.667C32.5875 21.6667 33.3337 20.9206 33.3337 20.0001C33.3337 19.0796 32.5875 18.3334 31.667 18.3334H21.667V8.33341C21.667 7.41294 20.9208 6.66675 20.0003 6.66675Z" fill="#57534E"/></g></svg>
                        </button>
                    </div>
                    {/*SELECT TABLE*/}
                    <div className="relative">
                ...
                <div className="flex gap-5 mt-8">
                    <button onClick={handleDelete} className="flex items-center p-6 rounded-xl bg-gradient-to-b from-[#fdfdfc] to-[#f6f6f6] shadow-md shadow-gray-300">
                    ...
                    <button onClick={handleEdit} className="flex-grow p-6 rounded-xl bg-gradient-to-b from-[#f0764b] to-[#d84714] shadow-md shadow-gray-300 text-lg text-white text-center">
                        Edit
                    </button>
                </div>
