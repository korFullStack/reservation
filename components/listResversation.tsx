...
const ListReservation = (props: ListReservationProps) => {
    ...
    return (
        <div className="BOOKING_LIST">
            ...
            <div className="bg-white grid grid-cols-3 items-center p-6">
                ...
                <div className="ADD_BTN">
                    <button onClick={handleAdd}
                            className="flex items-center gap-1 text-[#ec5823] font-medium p-4 rounded-lg bg-gradient-to-b from-[#fdfdfc] to-[#f6f6f6] shadow-lg shadow-gray-300 hover:opacity-90">
            ...
            {props.listReservation.map((item) => (
                <div onClick={()=> router.push(`/edit/${item.id}`)} key={item.id} className="bg-white rounded-xl shadow-xl p-6 flex flex-col gap-4 cursor-pointer">
                    <div className="flex items-center gap-4">
                        <h4 className="font-semibold">{item.name}</h4>
                        <div
                            className="flex items-center gap-1.5 py-2 px-2.5 rounded-2xl bg-gradient-to-b from-[#fdfdfc] to-[#f6f6f6] shadow-md shadow-gray-300 text-sm text-[#a8a29e]">
                            ...
                            <span>{item.phoneNumber.replace(/(\d{3})(\d{3})(\d{4})/, '$1-$2-$3')}</span>
                        </div>
                    </div>
                    ...
                    {item.table.length ?
                        ...
                        <p>Reserved Table</p>
                        <p className="text-lg text-[#292524]">{item.table.toString()}</p>
                        <p>•</p>
                        <p>Floor {Array.from(new Set(item.floor)).toString()}</p>
                    </div>) :
                                ...
                                <g id="trash">
                                    <g id="trash_2">
                                        <path fillRule="evenodd" clipRule="evenodd"
                                              ...
                                              fill="#DC2626"/>
                                        <path d="M17.5 10.4999H15.1667V19.8333H17.5V10.4999Z" fill="#DC2626"/>
                                        <path d="M12.8333 10.4999H10.5V19.8333H12.8333V10.4999Z" fill="#DC2626"/>
                                    </g>
                                </g>
                            </svg>
                        </button>
