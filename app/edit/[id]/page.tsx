            ...
            <div className="BOOKING_FORM bg-white flex flex-col gap-7 p-6">
                ...
                <div className="bg-white grid grid-cols-2 max-md:grid-cols-1 gap-6">
                    ...
                    <div className="flex items-center gap-4">
                        <span>Guest</span>
                        <button className="flex items-center justify-center gap-1 p-3 rounded-lg bg-gradient-to-b from-[#fdfdfc] to-[#f6f6f6] shadow-lg shadow-gray-300">
                        ...
                        <span className="px-3 text-2xl">4</span>
                        <button className="flex items-center justify-center gap-1 p-3 rounded-lg bg-gradient-to-b from-[#fdfdfc] to-[#f6f6f6] shadow-lg shadow-gray-300">
